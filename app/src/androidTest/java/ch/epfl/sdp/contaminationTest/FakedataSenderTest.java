...
public class FakedataSenderTest {
    ...
    public void NoErrorOnCreatingAndInsertingValuesWithProvider(){
        ...
        fDS.sendALocationToFirebase(new Location("provider"), Calendar.getInstance().getTime());
    }
    @Test(expected = Test.None.class)
    public void NoErrorOnCreatingAndInsertingValuesWithLocation(){
        ...
        fDS.sendALocationToFirebase(new Location(fakeLoc), Calendar.getInstance().getTime());
    }
    @Test
