 ...
 */
public class OldManager<A extends Comparable<A>, B> implements StorageManager<A, B> {
    ...
    public OldManager(Context context, String filename, Function<String, A> convertToA, Function<String, B> convertToB) {
